        ...
        <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    ...
                    <ul>
                        <li><a href="#" class="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Development</a></li>
                        <li><a href="#" class="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Our Products</a></li>
                        <li><a href="#" class="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">User Flow</a></li>
                        <li><a href="#" class="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">User Strategy</a></li>
                    </ul>
                </div>
            </div>
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    ...
                    <ul>
                        <li><a href="#" class="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">About</a></li>
                        <li><a href="#" class="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Contact & Support</a></li>
                        <li><a href="#" class="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Success History</a></li>
                        <li><a href="#" class="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Setting & Privacy</a></li>
                    </ul>
                </div>
            </div>
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    ...
                    <ul>
                        <li><a href="#" class="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Premium Support</a></li>
                        <li><a href="#" class="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Our Services</a></li>
                        <li><a href="#" class="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Know Our Team</a></li>
                        <li><a href="#" class="inline-block mb-2 text-base leading-loose text-body-color hover:text-primary">Download App</a></li>
                    </ul>
                </div>
            </div>
            <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
                <div class="w-full mb-10">
                    ...
                    <div class="flex items-center mb-6">
                        <a href="https://www.facebook.com/AlJaziraWalKingAcademy" target="_blank" class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                            <svg height="18" viewBox="0 0 8 16" class="fill-current">
                        ...
                        <a href="#" target="_blank" class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                            <svg height="18" viewBox="0 0 16 12" class="fill-current">
                        ...
                        <a href="#" target="_blank" class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                            <svg height="18" viewBox="0 0 14 14" class="fill-current">
