<header class="z-40 shadow-md shadow-teal-700 max-md:relative">
  ...
  <nav class="flex justify-between items-center px-[3%] py-1">
    ...
    <ul id="mune" class="negative">
      ...
      <li class="nav-link"><a href="#services">Members</a></li>
      <li class="nav-link"><a href="#about">About</a></li>
      <li class="nav-link"><a href="#contact-us">Contact Us</a></li>
      <button class="btn-search" role="search" id="model-search">
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="25" width="20" xmlns="http://www.w3.org/2000/svg">
          <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"></path>
        </svg>
      </button>
      <button class="btn-theme" role="switch" id="switch-theme" onclick="localStorage.getItem('theme') === 'light' ? (document.documentElement.className = 'dark', document.documentElement.setAttribute('data-theme', 'dark'), localStorage.setItem('theme', 'dark')) : (document.documentElement.className = 'light', document.documentElement.setAttribute('data-theme', 'light'), localStorage.setItem('theme', 'light'))">
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" class="dark:text-white" height="28">
    ...
    <button class="hidden max-md:block" onclick="document.querySelector('#mune').classList.toggle('!flex');">
