<header class="z-40 shadow-md shadow-slate-600 max-md:relative">
  ...
  <nav class="flex justify-between items-center px-[3%] py-1">
    ...
    <ul id="mune" class="negative" role="navigation">
      <x-ui.nav-link to="{{ route('home') }}">Home</x-ui.nav-link>
      <x-ui.nav-link to="{{ route('home') }}">Services</x-ui.nav-link>
      <x-ui.nav-link to="{{ route('home') }}">Events</x-ui.nav-link>
      <x-ui.nav-link to="{{ route('home') }}">About</x-ui.nav-link>
